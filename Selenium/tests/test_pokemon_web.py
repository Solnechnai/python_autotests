...
def test_positive_login():
    ...
    email.click()
    email.send_keys('user@mail.com')  # введи тут email своего тестового аккаунта на stage окружении
    ...
    password.click()
    password.send_keys('QA_studio1')  # введи тут пароль своего тестового аккаунта на stage окружении
    ...
    assert trainer_id.text.replace('\n', ': ') == 'ID: 105', 'Unexpected ID trainer'  # введи тут ID своего тренера